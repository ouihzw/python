...
from . import gettingSimilarWebElementListObjectSettingDialog
from ....webAutoConstants import WebAutoConstants

class GettingSimilarWebElementListFlowWidget(flowStepWidget.FlowStepWidget):
    def __init__(self, scene, title="Undefined Node", type = " Node ", id = None,inputs=[], outputs=[]):
        super(GettingSimilarWebElementListFlowWidget, self).__init__(scene, title, type, id, inputs=[1, 2, 3, 4], outputs=[])
        ...
        self.dialog = gettingSimilarWebElementListObjectSettingDialog.GettingSimilarWebElementListObjectSettingDialog(self.title,
                                                                                                                      self.directive["_id"],
                                                                                                            self.id)
