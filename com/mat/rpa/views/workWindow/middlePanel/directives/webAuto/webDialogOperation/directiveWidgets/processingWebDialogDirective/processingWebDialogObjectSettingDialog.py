...
class ProcessingWebDialogObjectSettingDialog(flowSettingDialog.BasicFlowSettingDialog):
    def __init__(self, title, parent=None):
        super(ProcessingWebDialogObjectSettingDialog, self).__init__(title, parent)
        #参照修改infolabel的提示信息
