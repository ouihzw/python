...
class MouseHoveringOverWebElementObjectSettingDialog(flowSettingDialog.BasicFlowSettingDialog):
    ...
    def seniorTabUI(self):
        ...
        self.waitWebLoadCheckbox.setText("模拟人工悬停")
        ...
        self.seniorTabLayout.addWidget(self.executeAfterLoadTimesOutLabel, 1, 0, 1, 1, Qt.AlignRight)
        ...
        self.seniorTabLayout.addWidget(self.executeAfterLoadTimesOutCombobox, 1, 1, 1, 3, Qt.AlignCenter)
        self.executeAfterLoadTimesOutTipLabel = flowSettingDialog.createTipLabel("执行后延迟(s)", "  执行指令完成后的等待时间")
        self.seniorTabLayout.addWidget(self.executeAfterLoadTimesOutTipLabel, 1, 4, 1, 1, Qt.AlignLeft)

        self.webLoadTimeOutPeriod4Label = QLabel()
        self.webLoadTimeOutPeriod4Label.setFont(__font)
        self.webLoadTimeOutPeriod4Label.setText("鼠标悬停位置：")
        self.seniorTabLayout.addWidget(self.webLoadTimeOutPeriod4Label, 2, 0, 1, 1, Qt.AlignRight)
        ...
        self.webLoadTimeOutPeriod4Combobox.setStyleSheet(
            "QComboBox QAbstractItemView{selection-background-color: #f0f0f0;selection-color: #000;} QComboBox QAbstractItemView::item{min-height: 50px;}")
        self.seniorTabLayout.addWidget(self.webLoadTimeOutPeriod4Combobox, 2, 1, 1, 3, Qt.AlignCenter)
        self.webLoadTimeOutPeriodTip4Label = flowSettingDialog.createTipLabel("锚点", "  未填")
        self.seniorTabLayout.addWidget(self.webLoadTimeOutPeriodTip4Label, 2, 4, 1, 1, Qt.AlignLeft)
        ...
        self.seniorTabLayout.addWidget(self.executeAfterLoadTimesOut2Label, 3, 0, 1, 1, Qt.AlignRight)
        ...
        self.seniorTabLayout.addWidget(self.executeAfterLoadTimesOut2Combobox, 3, 1, 1, 3, Qt.AlignCenter)
        self.executeAfterLoadTimesOutTip2Label = flowSettingDialog.createTipLabel("等待元素存在(s)", "  等待目标元素存在的超时时间")
        self.seniorTabLayout.addWidget(self.executeAfterLoadTimesOutTip2Label, 3, 4, 1, 1, Qt.AlignLeft)
    ...
    def executeStep(self):
        try:
            ...
            x = self.elementDaoMongo.getOneElement(self.elementLabel.text())["x"]
            y = webElement.location['y']
            browser_navigation_panel_height = client.execute_script('return window.outerHeight - window.innerHeight;')
            y = y + browser_navigation_panel_height
            print(x, y)
            pyautogui.moveTo(int(x), int(y), duration=0.25)
            ActionChains(client).move_to_element(webElement).perform()
