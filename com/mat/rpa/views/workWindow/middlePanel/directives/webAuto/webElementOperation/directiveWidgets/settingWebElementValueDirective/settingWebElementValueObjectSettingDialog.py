...
class SettingWebElementValueObjectSettingDialog(flowSettingDialog.BasicFlowSettingDialog):
    ...
    def __init__(self, title, directive_id, id, parent=None):
        ...
        self.setInfoLabelText(u"设置网页中元素的值，一般是input、select元素的value")
        __font = QFont()
    ...
    def regularTabUI(self):
        ...
        self.object1Label.setText("元素值:")
        self.directiveInputSettingLayout.addWidget(self.object1Label, 2, 0, 1, 1, Qt.AlignRight)
        self.elementValueLineEdit = QLineEdit()
        self.elementValueLineEdit.setObjectName("elementValueLineEdit")
        self.elementValueLineEdit.setFont(__font)
        self.elementValueLineEdit.setMinimumSize(600, 50)
        self.directiveInputSettingLayout.addWidget(self.elementValueLineEdit, 2, 1, 1, 2, Qt.AlignLeft)
        self.elementValueFunctionBtn = flowSettingDialog.addFunctionButton(self.elementValueLineEdit, self)
        self.directiveInputSettingLayout.addWidget(self.elementValueFunctionBtn, 2, 1, 1, 2, Qt.AlignRight)
        self.TipLabel = flowSettingDialog.createTipLabel(u"元素值",
                                                         u"  填写要设置的元素值")
    ...
    def executeStep(self):
        try:
            ...
            client.execute_script("arguments[0].value = arguments[1];", webElement, self.elementValueLineEdit.text())
    ...
    def getSettingData(self):
        ...
        self.elementValueLineEdit.setText(data["value"])
    ...
    def updateSettingData(self):
        ...
        data["value"] = self.elementValueLineEdit.text()
