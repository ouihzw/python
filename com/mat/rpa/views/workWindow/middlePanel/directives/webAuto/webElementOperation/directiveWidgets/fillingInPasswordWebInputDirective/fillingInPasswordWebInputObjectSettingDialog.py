...
class FillingInPasswordWebInputObjectSettingDialog(flowSettingDialog.BasicFlowSettingDialog):
    ...
    def __init__(self, title, directive_id, id, parent=None):
        ...
        self.setInfoLabelText('在网页的密码框中输入密码')
        __font = QFont()
    ...
    def regularTabUI(self):
        ...
        self.object1Edit = QLineEdit()
        self.object1Edit.setObjectName("object1Edit")
        self.object1Edit.setEnabled(True)  # 设置可以编辑
        self.object1Edit.setFont(__font)
        self.object1Edit.setEchoMode(QLineEdit.Password)
        self.object1Edit.setMinimumSize(600, 50)
        self.directiveInputSettingLayout.addWidget(self.object1Edit, 2, 1, 1, 2, Qt.AlignLeft)
    ...
    def seniorTabUI(self):
        ...
        self.webLoadTimeOutPeriod2Combobox.addItems(["50"])
        ...
        self.webLoadTimeOutPeriod3Combobox.addItems(["1000"])
    ...
    def executeStep(self):
        try:
            ...
            webElement.clear()
            webElement.send_keys(self.object1Edit.text())
