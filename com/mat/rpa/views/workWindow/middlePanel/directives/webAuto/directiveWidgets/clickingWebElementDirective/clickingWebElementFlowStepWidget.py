...
from . import clickingWebElementObjectSettingDialog

class ClickingWebElementFlowWidget(FlowStepWidget):
    def __init__(self, scene, title="Undefined Node", type=" Node ", id=None, inputs=[], outputs=[]):
        super(ClickingWebElementFlowWidget, self).__init__(scene, title, type, id, inputs=[1, 2, 3, 4], outputs=[])
        ...
        self.dialog = clickingWebElementObjectSettingDialog.ClickingWebElementObjectSettingDialog(self.title, self.directive["_id"], self.id)
