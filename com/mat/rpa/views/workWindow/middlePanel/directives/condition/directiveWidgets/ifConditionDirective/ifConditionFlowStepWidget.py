...
from . import ifConditionObjectSettingDialog
from ...conditionConstants import ConditionConstants

class IfConditionFlowWidget(flowStepWidget.FlowStepWidget):
    isFirstShow = True
    def __init__(self, lineNumber, indentLevel, flowTitle, lineNumberWidthSignal, parent=None):
        ...
        self.settingDialog = ifConditionObjectSettingDialog.IfConditionObjectSettingDialog(flowTitle, self)
