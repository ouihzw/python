...
class ElseObjectSettingDialog(flowSettingDialog.BasicFlowSettingDialog):
    def __init__(self, title, parent=None):
        ...
        # 改变图片
        self.changeImage(flowSettingDialog.BasicFlowSettingDialog.picPath + "elseBig.png")
        self.infoLabel.setText(u"如果不满足前面IF指令中指定的条件，则执行以下操作")
        self.regularTabUI()
    ...
    def regularTabUI(self):
        ...
        nothingInputLabel = QLabel(text=u"(当前指令不包含任何输入项)", font=__font)
        ...
        nothingOutputLabel = QLabel(text=u"(当前指令不包含任何输出项)", font=__font)
