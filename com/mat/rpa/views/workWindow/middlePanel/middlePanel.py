...
#consolePanel指的是下方的控制台，buttonpanel负责页面的切换，consolePanel负责内容的呈现
from com.mat.rpa.views.workWindow.middlePanel.consolePanel import consolePanel, buttonPanel
#负责流程呈现图部分的内容
from com.mat.rpa.views.workWindow.middlePanel.middleWindow.middleWindow import flowTabWindow
