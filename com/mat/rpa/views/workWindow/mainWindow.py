...
# 右边部分的工作区
from com.mat.rpa.views.workWindow.rightPanel import righPanel
from com.mat.rpa.dao.workDao.workDao import WorkDao  # 插入新的APP时需要用到
# 负责变量管理的内部逻辑
